 %% Detta är en specialvariant av Fysikteknologsektionens sånghäftesmall, anpassads pecifikt för Åttans alla måsenverser. Vill du lägga till en vers, redigera riktigamasen.tex i texter foldern. Första version anpassades  av ATM när denne var phaddergruppschef 2017. All credd till https://github.com/Fysikteknologsektionen/Sanghafte för en alldeles underbar mall.
% ---------------- %%% A4 konvertering %%% ----------------- %
% ---------------- %%%    AVANCERAT    %%% ----------------- %
