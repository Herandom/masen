 %% Detta är en specialvariant av Fysikteknologsektionens sånghäftesmall, anpassads pecifikt för Åttans alla måsenverser. 
 %% Vill du lägga till en vers, läs README.txt (txt borde gå att läsa på overleaf). 
 %% Första version anpassades  av ATM när denne var phaddergruppschef 2017. 
 %% Andra versionen fixades till av ATM när denne skulle toasta TackTack 2019-02-19, med Alla hjärtans dag tema.
 %% All credd för den faktiska svåra delen av texandet till https://github.com/Fysikteknologsektionen/Sanghafte för en alldeles underbar mall.
% ---------------- %%% A4 konvertering %%% ----------------- %
% ---------------- %%%    AVANCERAT    %%% ----------------- %
...
%% Värdar/Toastmasters %%
\newcommand{\host}
{\\Per ``ATM'' Hirvonen \\ Erik ``Dûscžhkqĕ'' Svensson} %Phaddergruppschef och vise när denna skit skapades
