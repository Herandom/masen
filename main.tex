 ...
 %%Vill du lägga till en vers, redigera riktigamasen.tex i texter foldern. 
 %%Första version anpassades  av ATM när denne var phaddergruppschef 2017. 
 %%All credd till https://github.com/Fysikteknologsektionen/Sanghafte för en alldeles underbar mall.
% ---------------- %%% A4 konvertering %%% ----------------- %
% ---------------- %%%    AVANCERAT    %%% ----------------- %
...
%% Värdar/Toastmasters %%
\newcommand{\host}
{\\Per ``ATM'' Hirvonen \\ Erik ``Dûscžhkqĕ'' Svensson}
